...
<body>
	...
	<header>
		...
		<nav>
			<ul>
				...
				<li id="login"><a id="allhead" href="">Admin</a></li>
	...
	<ul><li id="login">
		<a href="/userListPage${cid}" style="text-decoration: none;">Back</a>
	</li></ul></div>
	...
	<form:form action="/userModify" modelAttribute="user">
		<p>
		...
		<p>
			...
			<form:input path="userDept" />
		</p>
		<p>
			<label>User Phno:&nbsp;</label>
			<form:input path="userPhno" />
		</p>
