		...
		<c:forEach var="row" items="${list}">
			<tbody id="geeks">
				<tr>
					...
					<td>${row.userPhno}</td>
					<td>${row.userDept}</td>
					<td><a href="userModifyPage?uid=${row.userLoginId}&cid=${row.corporateId}" style="color: #00FA9A;">Modify</a></td>
					<td><a href="userDelete?cid=${row.corporateId}&uid=${row.userLoginId}" style="color: #498afb;">Delete</a></td>
				</tr>
			</tbody>
		</c:forEach>
	</table>
