...
<body>
	...
	<br>
	<br>
	<h3 style="text-align: center;"><b>Account Lists</b></h3>
	...
	<div id="brand" style="width: 70%; margin: auto; text-align: center;">
		<nav style="width: 100%;">
			...
			<ul><li id="login">
				<a href="accountPage" style="text-decoration: none;">Back</a>
			</li></ul></div>
			<b style="float: left; margin-top: 10px;padding-left: 5px;">Search: <input id="gfg"
				type="text" placeholder="Search here">
			</b>
			<ul style="float: right; margin-bottom: -5px;">
				<li id="login">
				<a style="text-decoration: none;"
					href="/addAccount${cid}">&#10010;Account</a>
					</li>
			</ul>
		</nav>
	</div>
		...
		<c:forEach var="row" items="${list}">
			<tbody id="geeks">
				<tr>
					...
					<td><a href="accDelete?cid=${row.corporateId}&accname=${row.accountName}" style="color: #ff3860;">Close Account</a></td>
				</tr>
			</tbody>
		</c:forEach>
	</table>
